          ...
          <div className="hidden lg:flex lg:col-span-5 flex-col items-start space-y-6 md:space-y-8">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <p className="text-xs md:text-sm text-slate-300 max-w-md font-semibold leading-relaxed">
                Direct and easy file transfers through the web. Max 10MB limit, no logins,
                and simple sharing without the hassle.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full pt-1">
              <div className="p-4 rounded-2xl glass-card flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-200">10MB Limit</h4>
                  <p className="text-[11px] text-slate-400 mt-0.5 leading-normal">Send packages up to 10MB instantly.</p>
                </div>
              </div>
              <div className="p-4 rounded-2xl glass-card flex items-start gap-3">
                <ShieldIcon className="text-purple-400 mt-0.5 text-xl" />
                <div>
                  <h4 className="text-xs font-bold text-slate-200">Secure Storage</h4>
                  <p className="text-[11px] text-slate-400 mt-0.5 leading-normal">Self-destructing server references.</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full p-5 md:p-6 rounded-3xl glass-panel border border-slate-900/80 space-y-4 relative overflow-hidden">
              ...
              <div className="flex justify-between items-center border-b border-slate-800/80 pb-3">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Supported File Types</span>
                <span className="text-[10px] text-indigo-400 font-bold uppercase tracking-wider">Fast Matching</span>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-900/40 border border-slate-800/60">
                  ...
                  <div>
                    <h5 className="text-[10px] font-bold text-slate-200">Documents</h5>
                    <p className="text-[9px] text-slate-400 mt-0.5">PDF, DOCX, TXT</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-900/40 border border-slate-800/60">
                  ...
                  <div>
                    <h5 className="text-[10px] font-bold text-slate-200">Archives</h5>
                    <p className="text-[9px] text-slate-400 mt-0.5">ZIP, RAR, 7Z</p>
                  </div>
                </div>

                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-900/40 border border-slate-800/60">
                  <ImageIcon className="text-indigo-400 text-lg" />
                  <div>
                    <h5 className="text-[10px] font-bold text-slate-200">Images</h5>
                    <p className="text-[9px] text-slate-400 mt-0.5">PNG, JPG, SVG</p>
                  </div>
                </div>

                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-900/40 border border-slate-800/60">
                  <AudioFileIcon className="text-sky-400 text-lg" />
                  <div>
                    <h5 className="text-[10px] font-bold text-slate-200">Audio/Video</h5>
                    <p className="text-[9px] text-slate-400 mt-0.5">MP4, MP3, WAV</p>
                  </div>
                </div>

                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-900/40 border border-slate-800/60">
                  <CodeIcon className="text-teal-400 text-lg" />
                  <div>
                    <h5 className="text-[10px] font-bold text-slate-200">Developer</h5>
                    <p className="text-[9px] text-slate-400 mt-0.5">JS, TS, PY, GO</p>
                  </div>
                </div>

                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-900/40 border border-slate-800/60">
                  <span className="w-5 h-5 rounded-md bg-slate-800 flex items-center justify-center text-slate-400 text-[9px] font-black">All</span>
                  <div>
                    <h5 className="text-[10px] font-bold text-slate-200">Other Files</h5>
                    <p className="text-[9px] text-slate-400 mt-0.5">Custom Formats</p>
                  </div>
                </div>
              </div>
            </div>
...
export default function Home() {
  return (
    <Suspense
      fallback={
        <div className="flex min-h-screen bg-[#0f172a] text-slate-500 items-center justify-center text-sm font-mono tracking-widest">
